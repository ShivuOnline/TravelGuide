...
public class HillStations extends Fragment implements HillStationMainAdapter.PlaceItemClickListener {
    ...
    @Override
    public void hillStationsPlaceItemClicked(int position, PlaceItem placeItem) {
//        Toast.makeText(requireContext(), "Hill Stations Item: " + position, Toast.LENGTH_SHORT).show();
    }
}