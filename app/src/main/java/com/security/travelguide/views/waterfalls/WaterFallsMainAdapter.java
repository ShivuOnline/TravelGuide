...
public class WaterFallsMainAdapter extends RecyclerView.Adapter<WaterFallsMainAdapter.ReligiousAdapterViewHolder> {

    private static final String TAG = WaterFallsMainAdapter.class.getSimpleName();
    /**
    ...
    public WaterFallsMainAdapter(Context context, List<PlaceItem> religiousMainItemList, PlaceItemClickListener listener) {
